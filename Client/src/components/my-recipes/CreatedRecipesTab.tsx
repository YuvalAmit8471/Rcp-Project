/**
 * Created Recipes Tab Content
 * Displays user's created recipes with management functionality
 */
...
interface CreatedRecipesTabProps {
  recipes: Recipe[];
  onDeleteRecipe: (id: string) => void;
}

export const CreatedRecipesTab = ({
  recipes,
  onDeleteRecipe,
}: CreatedRecipesTabProps) => {
  ...
  if (recipes.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-2xl font-bold mb-2">No recipes created yet</h3>
